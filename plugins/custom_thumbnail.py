...
@pyrogram.Client.on_message(pyrogram.filters.command(["generatecustomthumbnail@xploaderzxbot"]))
...
@pyrogram.Client.on_message(pyrogram.filters.command(["savecustomthumbnail@xploaderzxbot"]))
...
@pyrogram.Client.on_message(pyrogram.filters.command(["deletethumbnail@xploaderzxbot"]))
